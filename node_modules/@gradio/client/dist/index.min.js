...
function Dt(e, t, n) {
	...
	else if (n.type === "status" && n.original_msg === "process_starts") At(i, n.time);
	else if (n.type === "status" && (n.stage === "generating" || n.stage === "streaming")) i.streamed = !0;
	else if (n.type === "status" && n.stage === "complete") i.status = "completed", jt(i, n), a = !0;
	else if (n.type === "status" && n.stage === "error") i.status = "failed", i.error = typeof n.message == "string" ? n.message : JSON.stringify(n.message || "Unknown error"), jt(i, n), a = !0;
	else return;
	if (a) Q.has(t) && (i.outputs = Q.get(t)), Q.delete(t), kt.delete(t);
	else if (i.streamed) {
		if (Date.now() - (kt.get(t) ?? 0) < Ot) return;
		kt.set(t, Date.now()), Q.delete(t);
	}
	ht(e, r);
}
var Ot = 500, kt = /* @__PURE__ */ new Map(), Q = /* @__PURE__ */ new Map();
function At(e, t) {
...
function Ht(e, t = {}, n, r, i, a) {
	try {
		...
		let { fn_index: w, endpoint_info: T, dependency: E } = Wt(p, e, m, l), ae = ye(t, T), D = l.protocol ?? "ws";
...
var $ = class {
	...
	async config_success(e) {
		if (this.config = e, this.api_prefix = e.api_prefix || "", e.run_history === !1 && Nt({
			app_id: e.app_id,
			username: e.username
...
async function Gt(e, t = { events: ["data"] }) {
...
//#endregion
export { $ as Client, U as FileData, ae as MISSING_CREDENTIALS_MSG, Lt as apply_run_history_replay, Nt as clear_run_history, Gt as client, It as consume_run_history_replay, Pt as delete_run_history, Kt as duplicate, De as handle_file, Vt as on_run_history_change, Pe as predict, xe as prepare_files, Mt as read_run_history, ut as run_history_url, Ft as stage_run_history_replay, Ht as submit, H as upload, z as upload_files };
